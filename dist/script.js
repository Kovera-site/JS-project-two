...
var accordion = function accordion(triggersSelector) {
  ...
  }); // Акордкон при помощи стилей
  // blocks = document.querySelectorAll(itemsSelectors);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menuSelector, burgerSelecter) {
  var menuElem = document.querySelector(menuSelector),
      burgerElem = document.querySelector(burgerSelecter);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(size, material, option, promocode, result, state) {
...
var drop = function drop() {
  ...
  ['dragenter', 'dragleave', 'drop', 'dragover'].forEach(function (eventName) {
...
var filter = function filter() {
  ...
  function challengeFunction(elem, mark) {
  ...
  challengeFunction(btnAll, markAll);
  challengeFunction(btnLovers, markLovers);
  challengeFunction(btnChef, markChef);
  challengeFunction(btnGirl, markGirl);
...
var mask = function mask(selector) {
  var setCursorePosition = function setCursorePosition(pos, elem) {
    elem.focus();
    ...
    link.addEventListener('click', function (event) {
      ...
      function step(time) {
        ...
        var progress = time - start,
            r = toBlock < 0 ? Math.max(widthTop - progress / spead, widthTop + toBlock) : Math.min(widthTop + progress / spead, widthTop + toBlock);
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  try {
    var _prevBtn = document.querySelector(prev),
